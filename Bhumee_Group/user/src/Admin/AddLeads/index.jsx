...
const AddLeadForm = () => {
    ...
    const puneAreas = [
        ...
        "Baner Bypass Highway", "Baner-Pashan Link Road", "Baramati", "Bavdhan", "Bavdhan Khurd", "Bahul", "Bawada", "Bhekrai Nagar", 
        ...
        "Dhangarwadi", "Dhayari", "Dighi", "Dive", "Donaje", "Dhole Patil Road", "East Khadki", "Empress Gardens", "Erandwane", "Factory Road", 
        ...
        "Hadapsar", "Handewadi", "Handewadi Road", "Hinjawadi", "Hinjawadi Phase I", "Holewadi", "Ideal Colony", "Indapur", "Indira Nagar", 
        ...
        "Rasta Peth", "Raviwar Peth", "Revenue Colony", "Rihe", "Sainath Nagar", "Salisbury Park", "Sambhaji Nagar", "Sanaswadi", 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setFormData({ fullName: "", contactNumber: "", configuration: "", budget: "", area: "", assigned: "NOT ASSIGNED" });
            }
        } catch (error) {
