...
function DashBoradSliderBar() {
    ...
    const menus = [
        ...
        // { id: 2, name: 'Properties', link: '/admin/AllProperties', icons: 'dashboard_customize' },
        // { id: 4, name: 'Add Property', link: '/admin/AddProperty', icons: 'add' },
        { id: 6, name: 'Staff', link: '/admin/ManageStaff', icons: 'person' },
        // { id: 5, name: 'User Home', link: '/', icons: 'home' },
        { id: 3, name: 'Profile', link: '/admin/ShowProfile', icons: 'person ' },
