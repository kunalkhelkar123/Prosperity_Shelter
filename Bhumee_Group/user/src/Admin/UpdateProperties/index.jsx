          ...
          <form className=" w-full p-8" onSubmit={handleUpdate} >
           ...
           {/* <div>
            ...
            <div className=" mt-8 p-2 ">
              ...
              <button className="bg-red-500 text-white p-3 font-semibold rounded-lg border-red-500  hover:bg-white  hover:text-red-500  hover: border border-red-500" onClick={() => navigate("/admin/AllProperties")}>
                {" "}
                Cancle
              </button>
            </div>
