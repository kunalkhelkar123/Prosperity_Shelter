  ...
  return (
    <>
      ...
      <h2 className="text-lg text-white font-semibold flex items-center">
        ...
        <span className="text-yellow-400 font-bold"> help@realityone.com</span> 
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm">
          <strong>Head Office:</strong> 30/2/1, Reality One, 3rd Floor, Above Rajrshi Shahu Bank & BOB, Balaji Nagar, Dhankawadi, Katraj, Pune - 411043.
        </p>
          {/* <p className="text-sm">
            <strong>West Pune:</strong> Reality One, The Stellar, Office No. 307, 3rd Floor, Near New Poona Bakery & CNG Pump, Bhumkar Chowk, Wakad, Pune - 411056.
          </p>
          <p className="text-sm">
            <strong>East Pune:</strong> Reality One, 01B, A Wing, 2nd Floor, City Vista, Kharadi, Pune - 411014.
          </p> */}
      </div>
