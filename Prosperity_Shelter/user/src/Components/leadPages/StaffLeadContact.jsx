...
function LeadContact() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axiox.get("/api/property/getleads");
  ...
  const handleAddDescription = async (id) => {
    ...
    try {
      ...
      const response = await axiox.post("/api/property/addDescription", newDescription);
  ...
  const fetchDescriptions = async (leadId) => {
    try {
      const response = await axiox.get(`/api/property/getDescriptions/${leadId}`);
  ...
  const handleDeleteLead = async (id) => {
    ...
    try {
      const response = await axiox.delete("/api/property/deleteLead", {
        data: { leadId: id },
      });
